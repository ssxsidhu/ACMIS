...
public class DataAccessStub {
    ...
    public void open(String dbName){
        ...
        Flight calToTor1 = new Flight(calgary,toronto,"2022-1-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor1);
        Flight calToTor2 = new Flight(calgary,toronto,"2022-2-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor2);
        Flight calToTor3 = new Flight(calgary,toronto,"2022-3-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor3);
        Flight calToTor4 = new Flight(calgary,toronto,"2022-4-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor4);
        Flight calToTor5 = new Flight(calgary,toronto,"2022-5-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor5);
        Flight calToTor6 = new Flight(calgary,toronto,"2022-6-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor6);
        Flight calToTor7 = new Flight(calgary,toronto,"2022-7-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor7);
        Flight calToTor8 = new Flight(calgary,toronto,"2022-8-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
        allFlights.add(calToTor8);
        Flight calToTor9 = new Flight(calgary,toronto,"2022-9-31","10:30","2022-12-31","18:45");
        calgary.addLocationOutgoing(toronto);
        toronto.addLocationIncoming(calgary);
